...
with tabs[0]:
    ...
    st.plotly_chart(dch.fig_curva_abc(share_ordenado), use_container_width=True, key="tab0_abc")
...
with tabs[3]:
    ...
    st.plotly_chart(dch.fig_curva_abc(share_ordenado), use_container_width=True, key="tab3_abc")
